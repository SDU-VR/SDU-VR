...
public class SteamVR_RenderModel : MonoBehaviour
{
	...
	private Coroutine _SetModelAsyncCoroutine;
	private Coroutine _FreeRenderModelCoroutine;
	...
	public void UpdateModel()
	{
		...
		// TODO: PaulBro - prevent redundant simultaneous Coroutines
		// TODO: PaulBro - What if _FreeRenderModelCoroutine is running?
		if (this._SetModelAsyncCoroutine == null)
		{
			...
			if (renderModelName != s)
			{
				...
				this._SetModelAsyncCoroutine = StartCoroutine(SetModelAsync(s));
			}
		}
	}
	...
	IEnumerator SetModelAsync(string renderModelName)
	{
		...
		Done:
		// TODO: PaulBro - prevent redundant simultaneous Coroutines
		this._SetModelAsyncCoroutine = null;
	}
...
#endif
			// TODO: PaulBro - prevent redundant simultaneous Coroutines
			// TODO: PaulBro - What if _SetModelAsyncCoroutine is running? Should be cancel it?
			if (this._FreeRenderModelCoroutine == null)
				this._FreeRenderModelCoroutine = StartCoroutine(FreeRenderModel(pRenderModel));
